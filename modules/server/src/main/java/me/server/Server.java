...
public class Server {
    ...
    public static String CFGPATH = System.getProperty("user.dir") + File.separator + "Config.cfg";
    ...
    public static void main(String[] args) {
        try {
            ...
            if(!file.exists()) {
                ...
                configWriter.write(
                        CFGPATH,"lookandfeel",
                        MetalLookAndFeel.class.getCanonicalName()
                );
            }
            ...
            jMenuItem3.addActionListener(a->{
                try {
                    ...
                    configWriter.write(CFGPATH,"lookandfeel",MetalLookAndFeel.class.getCanonicalName());
            ...
            jMenuItem9.addActionListener(a->{
                file.delete();
                configWriter.write(CFGPATH,"port",port);
                configWriter.write(CFGPATH,"lookandfeel", SmartLookAndFeel.class.getCanonicalName());
                configWriter.write(CFGPATH,"head",head);
                configWriter.write(CFGPATH,"password",password);
                JOptionPane.showMessageDialog(null,"主题已经更改,请重启软件","提示",JOptionPane.WARNING_MESSAGE);
                System.exit(0);
            ...
            jMenuItem10.addActionListener(a->{
                file.delete();
                configWriter.write(CFGPATH,"port",port);
                configWriter.write(CFGPATH,"lookandfeel", LunaLookAndFeel.class.getCanonicalName());
                configWriter.write(CFGPATH,"head",head);
                configWriter.write(CFGPATH,"password",password);
                JOptionPane.showMessageDialog(null,"主题已经更改,请重启软件","提示",JOptionPane.WARNING_MESSAGE);
                System.exit(0);
